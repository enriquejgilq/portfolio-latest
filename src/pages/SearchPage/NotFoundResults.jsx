  ...
  return (
    <div className="flex flex-col justify-start items-start">
      {suggestionSearch.length > 0 && (
        <div className="flex flex-col md:flex-row">
          ...
          <Typography
            ...
            onClick={() =>
              handleSuggestionClick(suggestionSearch[0]?.description)
            }
          >
      ...
      <div style={{ textAlign: "start" }} className="text-black">
        ...
        >
          No se encontró ningún resultado que contenga todos los términos de
          búsqueda que ingresaste.
        </Typography>
      </div>
      <Typography
      ...
      <ul className="list-none text-left pl-0 mt-2 ">
        {suggestions.map((suggestion, index) => (
          <li
            key={index}
            className="flex items-center text-black text-sm m-0 p-0 "
          >
            <Typography
              sx={{ fontSize: { xs: "12px", md: "16px" } }}
              className="text-black"
